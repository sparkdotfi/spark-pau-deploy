...
abstract contract IControllerFull is IController, Controller {
    ...
    function getLayerZeroRecipients(uint32 destinationEndpointId) external view virtual returns (bytes32);
