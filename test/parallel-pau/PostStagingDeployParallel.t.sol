...
contract PostStagingDeployParallel is PostStagingDeployTestBase {
    ...
    function _setDeploymentAddresses() internal override {
        ...
        // Paste from script/input/1/deploy-mainnet-staging.json. A parallel deployment attaches to
        // the ALMProxy named there.
        ALM_PROXY = 0xe6A3179615cA28abd2d0a0d83bAAC21B24Ff7fFF;
